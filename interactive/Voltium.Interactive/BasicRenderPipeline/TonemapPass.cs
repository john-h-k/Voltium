...
//    {
//        public override RenderPassExternalOutput Output { get; }
...
//        {
//            _output = output;
//            Output = RenderPassExternalOutput.FromBackBuffer(OutputClass.Primary, _output);
//        }
...
//            context.Barrier(ResourceTransition.Create(_output.OutputBuffer, ResourceState.Present, ResourceState.CopyDestination));
//            context.CopyResource(sampledOutput, _output.OutputBuffer);
//            context.Barrier(ResourceTransition.Create(_output.OutputBuffer, ResourceState.CopyDestination, ResourceState.Present));
//        }
//    }
//}
