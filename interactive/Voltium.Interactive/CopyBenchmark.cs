...
//        private static QuerySet _copyQueryHeap;
//        private static QuerySet _queryHeap;
...
//            {
//                (_device.BeginCopyContext(), _device.BeginCopyContext(),  _device.QueueFrequency(DeviceContext.Copy)),
//                (_device.BeginComputeContext(), _device.BeginComputeContext(),  _device.QueueFrequency(DeviceContext.Compute)),
//                (_device.BeginGraphicsContext(), _device.BeginGraphicsContext(),  _device.QueueFrequency(DeviceContext.Graphics))
//            };

//            int numQueries = contexts.Length * 4;

//            _copyQueryHeap = _device.CreateQuerySet(QuerySetType.CopyTimestamp, 2 * numQueries);
//            _queryHeap = _device.CreateQuerySet(QuerySetType.GraphicsOrComputeTimestamp, 2 * numQueries);
