...
namespace Voltium.Common
{
    ...
    internal unsafe static class Helpers
    {
        ...
        public static (uint Lo32, uint Hi32) Pack2x24_16To2x32(uint lo24, uint mid24, ushort hi16)
            => (lo24 | (mid24 << 24), (mid24 >> 8) | ((uint)hi16 << 16));
        public static (uint Lo24, uint Mid24, ushort Hi16) Unpack2x32To2x24_16(uint lo32, uint hi32)
            => (lo32 & Lo24Mask, (lo32 >> 24) | ((hi32 << 8) & Lo16Mask), (ushort)(hi32 >> 16));
