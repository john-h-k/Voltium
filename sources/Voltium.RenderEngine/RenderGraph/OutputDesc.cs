...
namespace Voltium.RenderEngine
{
    ...
    public struct OutputDesc
    {
        ...
        public static OutputDesc CreateTexture(OutputClass type, DataFormat format, ulong width, uint height = 1, ushort depthOrArraySize = 1)
            => new OutputDesc { ResourceType = ResourceType.Texture, Format = format, Type = type, TextureWidth = width, TextureHeight = height, TextureDepthOrArraySize = depthOrArraySize };
